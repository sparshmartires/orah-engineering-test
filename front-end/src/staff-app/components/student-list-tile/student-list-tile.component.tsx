...
interface Props {
  ...
  setUsers?: (value: Person[]
    | undefined) => void,
  rollCall?: RolllStateType
  disableStateChange?: boolean
}
export const StudentListTile: React.FC<Props> = ({ isRollMode, student, id, setUsers, users, rollCall, disableStateChange = false }) => {
  return (
    <S.Container>
